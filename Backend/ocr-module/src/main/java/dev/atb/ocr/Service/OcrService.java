...
public class OcrService {
    ...
    public OcrDTO uploadAndAnalyzeImage(MultipartFile imageFile, String typeDocument, String numeroCompteId, String signatureBase64) {
        File tempFile = null;
        try {
            ...
            Optional<Compte> compteOpt = compteRepository.findById(numeroCompteId);
