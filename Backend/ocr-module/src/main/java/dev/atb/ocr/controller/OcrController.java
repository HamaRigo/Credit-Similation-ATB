...
public class OcrController {
     ...
     * @param id the account number associated with the document
    ...
    public CompletableFuture<ResponseEntity<OcrDTO>> uploadImageAsync(
            ...
            @RequestParam("id") @NotEmpty Long id) {
        ...
        try {
            ...
            OcrDTO ocrDTO = ocrService.uploadAndAnalyzeImage(file, typeDocument, id, signatureBase64);
